    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.tempat-kuliner.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama_tempat" name="nama_tempat" value="{{ old('nama_tempat') }}" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="jenis_makanan" name="jenis_makanan" value="{{ old('jenis_makanan') }}" required>
            </div>
            
            <div class="mb-3">
                <label for="jam_operasional" class="form-label">Jam Operasional <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="jam_operasional" name="jam_operasional" placeholder="Contoh: 08:00 - 22:00" value="{{ old('jam_operasional') }}" required>
            </div>
