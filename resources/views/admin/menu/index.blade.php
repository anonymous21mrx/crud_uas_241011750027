            ...
            <table class="table table-bordered table-striped" id="dataTableMenu" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($item->gambar)
                                <img src="{{ (str_starts_with($item->gambar, 'http') || str_starts_with($item->gambar, 'data:image')) ? $item->gambar : Storage::url($item->gambar) }}" alt="{{ $item->nama_menu }}" width="50" class="img-thumbnail">
                            @else
